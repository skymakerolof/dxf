...
function toPolylines(collector) {
  ...
  result = collector.circles.reduce(function(acc, circle) {
  ...
  result = collector.ellipses.reduce(function(acc, ellipse) {
  ...
  result = collector.arcs.reduce(function(acc, arc) {
  ...
  result = collector.splines.reduce(function(acc, spline) {
    console.log('!', spline);
