        ...
        if (entity) {
            ...
            switch (type) {
                ...
                case 70:
                    ...
                    // All dimension types have an optional 51 group code, which indicates the horizontal direction for the dimension entity.
                    // It determines the orientation of dimension text and lines for horizontal, vertical, and rotated linear dimensions.
                ...
                case 230:
                    ...
                    // Insertion point for clones of a dimension--Baseline and Continue (in OCS). APP: 3D point
                case 12:
                    entity.ix = value;
                    break;
                case 22:
                ...
                default:
                    if (emitter.verbose) {
                        console.log('Unhandled entityValue for dimension ' + this.type + ', Type: ' + type + ' Value: "' + value + '"');
                    }
                    break;
            }
        }
