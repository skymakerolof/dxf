        ...
        if (entity) {
            ...
            switch (type) {
                ...
                case 330:
                    entity.block = value;
                    break;
                case 62: // Color number (present if not BYLAYER). Zero indicates the BYBLOCK (floating) color. 256 indicates BYLAYER.
                ...
                default:
                    if (emitter.verbose) {
                        console.log('Unhandled entityValue for Line, Type: ' + type + ' Value: "' + value + '"');
                    }
                    break;
            }
        }
