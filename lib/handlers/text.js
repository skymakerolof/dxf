// For documentation on the Text element see http://www.autodesk.com/techpubs/autocad/acadr14/dxf/text_al_u05_c.htm
    ...
    emitter.on('entityValue', function(type, value) {
        ...
        if (entity) {
            ...
            If group 3 codes are used, the last group is a group 1 and has fewer than 250 characters. */
                ...
                default:
                    if (emitter.verbose) {
                        console.log('Unhandled entityValue for ' + this.type + ', Type: ' + type + ' Value: "' + value + '"');
                    }
                    break;
            }
        }
