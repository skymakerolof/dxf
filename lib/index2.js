...
const blocksHandler = require('./handlers2/blocks');
const entitiesHandler = require('./handlers2/entities');
...
module.exports.gatherByLayer = require('./gatherByLayer');
module.exports.layerToPolylines = require('./layerToPolylines');
